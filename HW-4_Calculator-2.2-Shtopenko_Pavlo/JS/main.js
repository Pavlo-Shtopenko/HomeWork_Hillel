...
switch (userOper){
    ...
    break;
    case 'cos': userFirstNum = +prompt('введіть Ваше значення числа');
                decision = Math.cos(userFirstNum);
    break;
    case 'sin': userFirstNum = +prompt('введіть Ваше значення числа');
                decision = Math.sin(userFirstNum);
    break;
    default: alert('Ви вказали недійсний операнд. Спробойте ще раз');
}
...
switch (true){
    ...
    break;
    default: alert(`Ваше рішення дорівнює ${decision} !`);
}
